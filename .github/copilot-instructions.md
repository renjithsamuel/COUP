...
Multiplayer Coup card game — FastAPI backend + Next.js 14 frontend. Real-time gameplay over WebSocket, lobby management via REST.
...
- Service layer: `frontend/src/services/` — API calls with snake_case → camelCase mapping
