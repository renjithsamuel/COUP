...
- Overlays and utility controls: full-screen overlays render through portals, the shared game utility controls host leaderboard, log, rules, and mute actions across desktop and mobile, and home/lobby/game flows now use a health-backed top connection overlay so free-hosting wake/reconnect states read clearly
