...
const SETTINGS: SettingDef[] = [
  { key: 'turnTimerSeconds', label: 'Turn Timer', options: TIMER_OPTIONS, defaultValue: 30 },
  { key: 'challengeWindowSeconds', label: 'Challenge Window', options: WINDOW_OPTIONS, defaultValue: 10 },
  { key: 'blockWindowSeconds', label: 'Block Window', options: WINDOW_OPTIONS, defaultValue: 10 },
  { key: 'startingCoins', label: 'Starting Coins', options: COIN_OPTIONS, defaultValue: 2 },
];
