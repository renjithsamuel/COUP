...
export function ActionButton({ actionType, onClick, disabled = false, playerCoins, isBluff = false, canAfford = true, compact = false }: ActionButtonProps) {
  ...
  return (
    <motion.button
      ...
      style={actionButtonStyles.button(isDisabled, isBluff, compact)}
      onClick={isDisabled ? undefined : onClick}
      disabled={isDisabled}
      title={`${rule.description}${isBluff ? ' (Bluff — you don\'t have this character)' : ''}`}
