...
export function ActionGlyph({ name, size = 16 }: ActionGlyphProps) {
  ...
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} aria-hidden="true">
      ...
      {name === 'tax' && (
        <>
          <path d="M12 5 18 8v4c0 4-2.7 6.6-6 7-3.3-.4-6-3-6-7V8l6-3Z" {...stroke} />
      ...
      {name === 'block' && (
        <>
          <path d="M12 4 18 7v4c0 4.2-2.8 7.3-6 8-3.2-.7-6-3.8-6-8V7l6-3Z" {...stroke} />
          <path d="M9 12h6" {...stroke} />
        </>
      )}
      {name === 'reveal' && (
        <>
          <path d="M3.5 12s3.2-5 8.5-5 8.5 5 8.5 5-3.2 5-8.5 5-8.5-5-8.5-5Z" {...stroke} />
