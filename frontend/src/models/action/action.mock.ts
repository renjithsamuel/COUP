...
export const mockAssassinateRule: ActionRule = ACTION_RULES[ActionType.ASSASSINATE];
...
export const mockForeignAidRule: ActionRule = ACTION_RULES[ActionType.FOREIGN_AID];
