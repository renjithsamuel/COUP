...
export function getChallengeBlockOverlayStyles(mobile: boolean) {
  return {
    ...
    panel: {
      ...
      padding: mobile ? `${tokens.spacing.md}px` : `${tokens.spacing.lg}px ${tokens.spacing.xl}px`,
      borderRadius: mobile ? 22 : 28,
      background: 'linear-gradient(180deg, rgba(12, 18, 34, 0.98) 0%, rgba(8, 12, 24, 0.98) 100%)',
    ...
    challengeBtn: {
      ...
      background: 'linear-gradient(180deg, rgba(88,24,24,0.98) 0%, rgba(45,16,18,0.96) 100%)',
      color: '#FEB2B2',
    ...
    blockBtn: {
      ...
      background: 'linear-gradient(180deg, rgba(22, 46, 84, 0.98) 0%, rgba(12, 25, 48, 0.96) 100%)',
      color: '#9CC8FF',
      boxShadow: '0 16px 30px rgba(0,0,0,0.24)',
    } satisfies CSSProperties,
    ...
    acceptBtn: {
      ...
      background: 'linear-gradient(180deg, rgba(24, 36, 58, 0.98) 0%, rgba(12, 18, 32, 0.98) 100%)',
      color: tokens.text.primary,
    } satisfies CSSProperties,
  };
}
